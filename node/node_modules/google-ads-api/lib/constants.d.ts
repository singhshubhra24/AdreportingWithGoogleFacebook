export declare const ADWORDS_API_BASE_URL = "https://googleads.googleapis.com/v0/customers/";
export declare const ADWORDS_AUTH_URL = "https://accounts.google.com/o/oauth2/token";
...
export declare enum RESOURCE_NAMES {
    campaign = "campaign",
